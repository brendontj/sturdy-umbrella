...
func TestAuctionExecutions(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			name: "One bidder",
			bidders: []bidder.Bidder{
				newBidderForTest("Bidder 1", 1_00, 10_00, 10),
			},
		...
		},
		{
			...
			bidders: []bidder.Bidder{
				newBidderForTest("Bidder 1", 1_00, 10_00, 9_00),
				newBidderForTest("Bidder 2", 1_00, 10_00, 9_00),
			},
		...
		},
		{
			...
			bidders: []bidder.Bidder{
				newBidderForTest("Bidder 1", 9_80, 10_00, 9_00),
				newBidderForTest("Bidder 2", 1_00, 10_00, 4_40),
			},
			expectedWinnerName: "Bidder 1",
		...
		},
		{
			name: "Case Auction #1",
			bidders: []bidder.Bidder{
				newBidderForTest("Sasha", 50_00, 80_00, 3_00),
				newBidderForTest("John", 60_00, 82_00, 2_00),
				newBidderForTest("Pat", 55_00, 85_00, 5_00),
			},
		...
		},
		{
			name: "Case Auction #2",
			bidders: []bidder.Bidder{
				newBidderForTest("Riley", 700_00, 725_00, 2_00),
				newBidderForTest("Morgan", 599_00, 725_00, 15_00),
				newBidderForTest("Charlie", 625_00, 725_00, 8_00),
			},
		...
		},
		{
			name: "Case Auction #3",
			bidders: []bidder.Bidder{
				newBidderForTest("Alex", 2500_00, 3000_00, 500_00),
				newBidderForTest("Jesse", 2800_00, 3100_00, 201_00),
				newBidderForTest("Drew", 2501_00, 3200_00, 247_00),
			},
...
func newBidderForTest(name string, initialBid, maxBid, incrementAmount int) bidder.Bidder {
	bidderRef, _ := bidder.New(name, initialBid, maxBid, incrementAmount)
	return *bidderRef
}
